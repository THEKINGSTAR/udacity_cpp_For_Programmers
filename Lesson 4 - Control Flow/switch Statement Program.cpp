/*
The program below demonstrates the use of a switch statement in C++.

Recall, break statements are optional. 
In this first example, notice, there are no break statements between the cases. 
This means when a menu item is selected the case statement associated with that choice is executed, 
as well as each case statement that comes after it.
