...
class ClassName
{
    ...
    ...
        ...
        public : return variable
                 accessFunction1(function parameters);
...
//------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    It is best to use the convention for the group paying you to code.

    C++ Convention is:

    Capitalize the first letter of the classname.
    class ClassName
    Private members are listed first. If you do this, there is no need to use the 'private' keyword.

     If you list them after the public keyword, you will need to identify them using the private keyword.
    {
          member1;
          member2;
          ...
