...
For this example we are going to put them in the main file so we can see both the main program and the class at the same time. 
Hopefully, this will make it a little easier to see what is going on in the program.
...
There is another operator (->) that is used for accessing pointer members of a class. 
